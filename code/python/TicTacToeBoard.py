...
class TicTacToeBoard():
    def __init__(self):
        ...
        self.emptyPlaces = ["A1", "A2", "A3", "B1", "B2", "B3", "C1", "C2", "C3"]  # noqa
        self.playedMoves = []
    ...
    def isGameOver(self):
        ...
        if (self.board[0][0] == self.board[1][1] and self.board[0][0] == self.board[2][2]):  # noqa
            if self.board[0][0] != "-":
                self.is_game_over = True
                self.winner = self.board[0][0]
                return True

        if (self.board[0][2] == self.board[1][1] and self.board[0][2] == self.board[2][0]):  # noqa
            if self.board[0][2] != "-":
                self.is_game_over = True
