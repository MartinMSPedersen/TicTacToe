public class TicTacToeBoard
{
	...
	public TicTacToeBoard()
	{
		...
		for (unsigned int row=0; row<3; row++)
			for (unsigned int col=0; col<3; col++)
				this.board[row][col] = '-';
		this.emptyPlaces.push_back("A1");
		this.emptyPlaces.push_back("A2");
		this.emptyPlaces.push_back("A3");
		this.emptyPlaces.push_back("B1");
		this.emptyPlaces.push_back("B2");
		this.emptyPlaces.push_back("B3");
		this.emptyPlaces.push_back("C1");
		this.emptyPlaces.push_back("C2");
		this.emptyPlaces.push_back("C3");
	}
	...
	public vector<string> legalMoves() // const
	{
		;
	}
